# Python script to parse / display VDI pool usage during a certain date range,
...
def get_User_Input():
    ...
    user_choice = str(input('Please enter the number of the task you want to perform \n \n'))
